...
public class OverwhelmedConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_CHARCOAL =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(MOD_ID, "ore_charcoal"));
