...
public class GardenSnailRenderer extends MobRenderer<Snail, SnailGardenModel<Snail>> {
    ...
    public GardenSnailRenderer(EntityRendererProvider.Context context) {
        super(context, new SnailGardenModel<>(context.bakeLayer(OverwhelmedModelLayers.SNAIL_GARDEN_MODEL_LAYER)),
                0.2f);
    }
