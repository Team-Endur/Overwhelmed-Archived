...
public class HornetLarvaAnimation {
        public static final AnimationDefinition HORNET_LARVA_WALK = AnimationDefinition.Builder.withLength(3f).looping()
            .addAnimation("body",
    ...
    public static final AnimationDefinition HORNET_LARVA_IDLE = AnimationDefinition.Builder.withLength(3f).looping()
            .addAnimation("body",
                    new AnimationChannel(AnimationChannel.Targets.SCALE,
                            new Keyframe(0f, KeyframeAnimations.scaleVec(1f, 1f, 1f),
                                    AnimationChannel.Interpolations.CATMULLROM),
